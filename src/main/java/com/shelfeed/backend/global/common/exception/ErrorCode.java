...
public enum ErrorCode {//enum 타입은 public 불가(자동 private) + 객체 생성 시 new 안됨
    ...
    //좋아요
    REVIEW_LIKE_NOT_FOUND(404,"L001", "감상 좋아요 내역이 존재하지 않습니다."),
    COMMENT_LIKE_NOT_FOUND(404,"L002", "댓글 좋아요 내역이 존재하지 않습니다."),
    ALREADY_REVIEW_LIKED(409,"L003", "이미 좋아요한 감상입니다."),
    ALREADY_COMMENT_LIKED(409,"L004", "이미 좋아요한 댓글입니다."),
    //팔로우
